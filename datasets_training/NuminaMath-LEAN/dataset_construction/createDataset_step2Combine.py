...
file_pattern = "./datasets_training/NuminaMath-LEAN/dataset_step2-*.csv"
...
# Save combined file
final_df.to_csv("./datasets_training/NuminaMath-LEAN/dataset_step2.csv", index=False)
...
counts = (
    final_df.groupby(["has_fl_proof?", "fl_proof_compiles?"])
    .size()
